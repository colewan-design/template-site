            ...
            <v-window-item :value="1" key="sub1" style="padding-left:.25rem;padding-right:.25rem;padding-bottom:1rem;">
                ...
                <v-row>
                    <v-col cols="4" class="ta-center">
                        <v-btn variant="text"> To Review</v-btn>
                    </v-col>
                    <v-col  cols="4" class="ta-center">
                        <v-btn variant="text"> To Follow-up</v-btn>
                    </v-col>
                    <v-col  cols="4" class="ta-center">
                        <v-btn variant="text">History</v-btn>
                    </v-col>
                </v-row>
            <v-row>
                ...
                <v-card width="600" style="padding:1rem" v-for="n in 3" :key="n">
                    <v-row>
                        ...
                        <v-col cols="5" class="fs-20 fw-900 p-14" style="padding-top:10px">
                            SHOPNAME
                    ...
                    <v-row>
                        ...
                        <v-col>
                            <v-container>
                                ...
                                <v-row>
                                    <v-col cols="8"></v-col>
                                <v-col cols="4"> <v-btn class="ta-right" variant="outlined" color="red" @click="tab = 2">Review</v-btn> </v-col>
                                </v-row>
                            </v-container>
                        </v-col>
                    </v-row>
                    ...
                    <v-card width="600" style="padding-left:1rem;padding-right:.25rem;margin-bottom:1rem;padding-top:1rem;">
                       ...
                       <v-container>
                        <v-row>
                            ...
                            <v-col cols="2">
                                <v-icon size="15" style="padding-top: 10px;">
                                    mdi-chevron-down
                                </v-icon>
                            </v-col>
                        </v-row>
